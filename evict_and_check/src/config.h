...
#define DEF_RESAMPLE_SLEEP_TIME_US (1000)
...
#define DEF_WS_ACCESS_SLEEP_TIME_US (1000 * 1000ULL)
#define DEF_WS_EVALUATION_SLEEP_TIME_US (5 * 1000 * 1000ULL)
// not implemented yet
...
#define DEF_SS_ACCESS_SLEEP_TIME_US (0)
#define DEF_SS_ACCESS_THREAD_COUNT 1
