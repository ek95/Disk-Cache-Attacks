...
#define DEF_WS_PS_ADD_THRESHOLD 12ULL
#define DEF_WS_ACCESS_THREAD_COUNT 96ULL
#define DEF_WS_ACCESS_THREADS_PER_PU 24ULL
#define DEF_WS_ACCESS_SLEEP_TIME_NS 987651981ULL
#define DEF_WS_ACCESS_SLEEP_TIME_S 0ULL
#define DEF_WS_EVALUATION 1ULL
#define DEF_WS_EVICTION_IGNORE_EVALUATION 1ULL
#define DEF_WS_EVALUATION_SLEEP_TIME_NS 13588390ULL
#define DEF_WS_EVALUATION_SLEEP_TIME_S 1ULL
...
#define DEF_BS_MIN_AVAILABLE_MEM 204162091ULL
#define DEF_BS_MAX_AVAILABLE_MEM 237716523ULL
#define DEF_BS_EVALUATION_SLEEP_TIME_NS 283205224ULL
#define DEF_BS_EVALUATION_SLEEP_TIME_S 4ULL
